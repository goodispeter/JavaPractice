package Peter.OCAPreviousExam.Question42;

// You are developing a banking module. You have developed a named ccMask that has a maskcc method.
// Given the code fragment:
public class CCMask {
    public static String maskCC(String creditCard) {
        String x = "XXXX-XXXX-XXXX-";
        // line n1
        return null;// line n1 include this line
    }
    ...
    // seperate each group of four digits).
    // Which two code fragments should you use at line n1 , independtly, to achieve
